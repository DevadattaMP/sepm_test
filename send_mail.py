...
def main():
    ...
    body = "Hello, This email is generated using python script on github, exicuted as Jenkins job. For authentication of mail server, it is using environment variables. For more details, please visit https://github.com/DevadattaMP/sepm_test/"
